...
pipeline {
    ...
    stages {
        ...
        stage('Docker image') {
            ...
            steps {
                sh 'docker build -t krlsedu/csctracker-yahoofinance:' + env.VERSION_NAME + ' -t krlsedu/csctracker-yahoofinance:latest  .'
            }
        }
        stage('Docker Push') {
            agent any
            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'dockerHub', passwordVariable: 'dockerHubPassword', usernameVariable: 'dockerHubUser')]) {
                    ...
                    sh 'docker push krlsedu/csctracker-yahoofinance:' + env.VERSION_NAME
